...
class GanjoorCategory(models.Model):
    poet = models.ForeignKey(GanjoorPoet, on_delete=models.CASCADE, related_name='categories')
...
class GanjoorPoem(models.Model):
    category = models.ForeignKey(GanjoorCategory, on_delete=models.CASCADE, related_name='poems')
...
class GanjoorVerse(models.Model):
    poem = models.ForeignKey(GanjoorPoem, on_delete=models.CASCADE, related_name='verses')
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=['order', 'poem'], name='unique_verse_per_poem')
        ]
        ordering = ['order']
...
class GanjoorFavorite(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=['user', 'poem'], name='unique_user_poem_fav')
        ]
...
class GanjoorPoemAudio(models.Model):
    poem = models.ForeignKey(GanjoorPoem, on_delete=models.CASCADE, related_name='audios')
